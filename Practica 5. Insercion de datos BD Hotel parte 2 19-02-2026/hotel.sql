...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 19-02-2026 a las 16:15:12
...
(4, 1, 3, '2026-02-18', 'este hotel es tan bueno que podria morir'),
(5, 6, 4, '2026-02-18', 'este hotel es tan malo que podria morir'),
(6, 4, 2, '2017-06-07', 'Como dis... Como que si te vas a un hotel y dices \"esta bonito\", este, obvia... Y en tu mente no pie'),
(7, 5, 3, '2001-09-11', 'ta bien,ta fino, ta barato, incluye viajes y muy bonitas vistas'),
...
(1, 6, '2026-02-20', 100000, 'en feria', '78676723067', 'tru'),
(2, 1, '1918-12-18', 20000, 'especie', '18986747867', 'sin pagar'),
(3, 3, '2020-02-01', 1000000000, 'manzanas', '71829937467', 'pagado'),
...
(1, 'Viaje a la isla de Einstein', 20),
(2, 'Spa', 300),
(3, 'Alberca', 100),
(4, 'Desayuno', 500),
(5, 'Casino Balatro Balatrez', 400000);
